...
class Fish(RotatedImage):
    ...
    def defeated(self):
        ...
        # Просто скрываем рыбу без анимации
        self.opacity = 0
    ...
    def on_touch_down(self, touch):
        ...
        if not self.anim_play and not self.interaction_block:
            ...
            # Клік призвів до знищення риби
                ...
                # Запуск новой рыбки после 0.5 секунды
                Clock.schedule_once(self.new_fish, 0.5)
...
class Game(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.fish_widget.set_game_screen(self)
        ...
        self.shop_panel.x = Window.width
